...
node scripts/cogentia.js docs readmes review --repo <repo> --summary --json # idempotent local review
node scripts/cogentia.js docs readmes review --repo <repo> --emit-continuations # evidence-backed review packets
