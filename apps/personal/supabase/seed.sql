-- ============================================================
-- SEED : insertion du prompt Cogentia v1.0 réel
-- À exécuter dans l'éditeur SQL Supabase APRÈS le schema
-- ============================================================

update public.prompt_versions
set content = '[COGENTIA — PROTOCOLE D''ANALYSE PSYCHOCOGNITIVE v1.0 | PrivAI]
