...
| [KYS (Know Your Self) / Psychocognitive Analysis](./concepts.md#kys-know-your-self-psychocognitive-analysis) | project-specific | Working | protocol |
| [Cogentia Workflows](./concepts.md#cogentia-workflows) | repository-specific | Defined | system model |
| [Packet Capsule](./concepts.md#packet-capsule) | cross-corpus | Defined | data structure |
| [Human-Routed Handoff](./concepts.md#human-routed-handoff) | cross-corpus | Defined | protocol |
| [Recursive Reality Test](./concepts.md#recursive-reality-test) | cross-corpus | Defined | methodology |
| [Eventual Reconciliation](./concepts.md#eventual-reconciliation) | cross-corpus | Defined | mechanism |
<!-- END_AUTO: concepts -->
## Concept Graph
