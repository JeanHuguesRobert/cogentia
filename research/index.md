...
| [KYS / Cogentigram privacy — full private; specialized public prototypes](kys_profile_privacy_and_public_specialized_profiles.md) *(full KYS/Cogentigram private; PrivAI-oriented specialized profiles may be public dogfood)* | this repo | 2026-08-13 |
| [Using specialized KYS style profiles for Agent JHN fidelity](cogentigram_for_agent_jhn_fidelity.md) *(public specialized answer-style profile + private full KYS boundary)* | this repo | 2026-08-13 |
| [JHN answer-style KYS profile (public specialized prototype)](cogentigram_jhn_thinking_capsule.md) *(experimental public style dogfood for Agent JHN — not full private Cogentigram)* | this repo | 2026-08-13 |
