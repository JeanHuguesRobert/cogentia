...
Cette note part d’un cas concret — la marginalisation progressive de l’email Internet standard au profit de portails propriétaires, formulaires captifs, messageries internes, tickets, applications mobiles, chatbots et adresses `no-reply` — pour poser une problématique plus générale : la **traçabilité symétrique** des interactions entre individus et personnes morales.

Le problème n’est pas de défendre nostalgiquement l’email. Le problème est que l’email ordinaire, malgré ses limites, possède plusieurs propriétés politiquement et juridiquement importantes : il est copiable, transférable, archivable, exportable, horodatable, réplicable, intégrable à un dossier, transmissible à un tiers, et il permet la continuité d’un fil contradictoire. Lorsqu’une personne morale impose un canal propriétaire sans offrir de trace équivalente ou supérieure, elle ne change pas seulement l’outil de communication. Elle transforme le rapport de force.

La thèse centrale est la suivante :

> Dans toute interaction asymétrique entre un individu et une personne morale, la traçabilité n’est pas un supplément documentaire. Elle est une condition minimale de capacité, de preuve, de contestation et de liberté pratique.

Cette note propose le concept de **capture relationnelle par architecture de canal** : situation dans laquelle l’organisme qui impose le canal contrôle aussi la trace, le statut, le rythme, l’historique, la preuve et parfois la possibilité même de répondre.

Elle distingue cette capture des justifications légitimes : lutte contre le spam, sécurité, confidentialité, authentification, structuration des demandes, intégration métier, protection des agents ou gestion de charge. Ces raisons existent. Mais elles ne justifient pas l’absence de copie complète, d’export, d’accusé probatoire, de mise en copie, de canal de secours, ni de possibilité de constituer une mémoire indépendante.
...
- **Autonomie de Capacité** : un droit théorique n’a de valeur réelle que si la personne dispose des moyens pratiques de l’exercer, de le prouver, de le transmettre et de le défendre.
- **Traçabilité des actes** : tout acte significatif accompli par un organisme, un mandataire, un agent ou une institution doit être imputable, vérifiable, transmissible et contestable.
- **Interaction Packets** : les interactions doivent pouvoir être résumées en unités documentaires traçables : demande, réponse, silence, relance, refus, correction, preuve, statut.
- **Documents autoporteurs** : un dossier doit pouvoir être compris et évalué sans dépendre entièrement d’un portail, d’un compte, d’un agent ou d’une mémoire personnelle.
- **Cogentia** : la continuité cognitive suppose une continuité documentaire et probatoire ; une interaction opaque empêche la continuation par un humain, un collectif ou un agent IA mandaté.
- **Anti-capture** : les architectures techniques ne sont pas neutres ; elles peuvent capturer les relations, les preuves et les capacités.

La cohérence générale peut être formulée ainsi :
...
Traçabilité des actes
    qui exige
Canaux ouverts ou exportables
    qui permettent
Interaction Packets
    qui nourrissent
Corpus vivant versionné
    qui permet
Cogentia / continuité cognitive
    qui soutient
Démocratie directe, anti-capture et responsabilité institutionnelle
```

Formule doctrinale :

> Sans trace indépendante, il n’y a pas de mémoire opposable. Sans mémoire opposable, il n’y a pas de contestation effective. Sans contestation effective, il n’y a pas d’autonomie réelle.
...
Une personne ne peut réellement exercer un droit, défendre un intérêt légitime, contester une décision, relancer un organisme, transmettre un dossier, se faire assister, produire une preuve ou corriger une erreur que si elle dispose d’une trace suffisante de ce qui a été fait, dit, reçu, ignoré, modifié ou refusé.

La question décisive n’est donc pas :

> Quel canal l’organisme préfère-t-il ?

Mais :

> Le canal imposé permet-il à l’autre partie de conserver une trace complète, portable, vérifiable et opposable ?
...
- intelligible ;
- vérifiable ;
- conservable hors du système de l’autre partie ;
- transmissible à un tiers légitime ;
- utilisable en cas de relance, médiation, recours, audit ou contentieux.
...
> Le canal n’est pas un simple tuyau. Il définit ce qui peut être demandé, prouvé, transmis, contesté et mémorisé.
...
> Les traces individuelles peuvent-elles devenir un matériau d’audit collectif sans être entièrement capturées par les organismes concernés ?
...
La tension est donc double :

- le droit reconnaît de plus en plus les traces électroniques ;
- les usages sociaux les emploient quotidiennement ;
- mais les architectures captives peuvent empêcher l’individu de constituer ces traces sous une forme indépendante.

Formule :

> Le droit reconnaît la preuve électronique ; les portails captifs peuvent empêcher l’usager de la constituer.
...
Ces raisons sont réelles. Elles justifient l’encadrement. Elles ne justifient pas la confiscation de la trace.
...
Le raisonnement fautif est :

```text
Le spam existe.
Donc l’email est dangereux ou ingérable.
Donc nous fermons la réponse email.
Donc l’usager doit passer par notre interface.
Donc nous contrôlons le canal, la trace et le rythme.
```

Le raisonnement proportionné serait :

```text
Le spam existe.
Donc nous devons filtrer, authentifier et structurer les flux.
Mais nous devons préserver une trace symétrique.
Donc le canal imposé doit fournir les propriétés minimales que l’email permettait :
copie, réponse, export, horodatage, tiers en copie, fil, preuve.
```

Formule :

> Le spam justifie une hygiène du canal ; il ne justifie pas une souveraineté unilatérale sur la relation.

Ou :

> L’anti-spam devient prétexte lorsqu’il ne protège plus l’échange, mais protège l’organisation contre la réciprocité.

Principe proposé :

> Toute mesure anti-spam qui réduit la capacité de réponse, de copie, d’export ou de preuve doit être compensée par une traçabilité équivalente ou supérieure.
...
> L’organisme peut écrire à l’individu, mais l’individu ne peut pas répondre dans le même fil.

Il casse :

- la continuité conversationnelle ;
- la preuve de réponse ;
- les métadonnées du fil ;
- la mise en copie ;
- la relance ;
- la contestation contextualisée ;
- l’archivage complet ;
- la symétrie minimale de la correspondance.

Formule :

> Le `no-reply` est une hybridation trompeuse : il utilise l’email comme canal descendant, mais refuse l’email comme canal contradictoire.

Le `no-reply` ne doit pas être interdit dans tous les cas. Il peut être acceptable pour des notifications techniques strictement unilatérales. Mais il devient problématique dès qu’il concerne une interaction significative : décision, facture, relance, mise en demeure, dossier, refus, information opposable, clôture, notification de droits ou obligation d’action.
...
- un indice daté ;
- une trace de relance ;
- une preuve de notification selon les circonstances ;
- une pièce corroborée ;
- un élément d’un faisceau probatoire ;
- une base pour une chronologie ;
- un support d’imputation ou de contradiction.
...
> Plus le droit reconnaît la valeur potentielle des traces électroniques, plus certaines organisations construisent des canaux qui empêchent l’individu de produire ces traces sous une forme indépendante.

Cela ne prouve pas nécessairement une intention explicite. Mais cela révèle un avantage structurel :
...
- flux entrants domestiqués ;
- responsabilité diluée ;
- preuve conservée en interne ;
- contestation rendue coûteuse ;
- comparaison rendue difficile ;
- cas atypiques neutralisés ;
- audit externe empêché.

Formule à manier avec prudence :

> Lorsque la preuve électronique devient dangereuse pour les institutions, celles-ci ne la contestent plus frontalement ; elles organisent des canaux où elle naît, reste et meurt chez elles.

Version plus sobre :

> Les architectures captives ne suppriment pas nécessairement la preuve ; elles déplacent la preuve du côté de l’organisation.
...
|---|---|---|
| `no-reply` | Message descendant sans réponse possible | Rupture de réciprocité |
| Formulaire sans copie | Demande envoyée sans archive complète | Perte de preuve initiale |
| Portail fermé | Historique consultable seulement dans le compte | Dépendance d’accès |
| Ticket propriétaire | Traitement interne opaque | Impossibilité d’audit externe |
| Chatbot obligatoire | Filtrage automatique des demandes | Disparition des cas atypiques |
| Notification sans contenu | “Un message vous attend” | Trace email vidée de sa substance |
| Application obligatoire | Canal lié à appareil, OS, version | Exclusion technique |
| Capture d’écran comme seule preuve | Export absent | Preuve fragile et non structurée |
| Parcours de résiliation complexe | Friction organisée | Maintien forcé de la relation |
| Compte supprimé = historique perdu | Mémoire révocable | Dépossession probatoire |
| Statut sans historique | “En cours”, “traité”, “clos” | Décision ou inertie indémontrable |
| Pièces sans empreinte | Dépôt non vérifiable | Contestation de contenu facilitée |
...
|---|---:|---|
| Filtrage SPF/DKIM/DMARC | Oui | faux positifs traitables |
| Adresse dédiée | Oui | adresse répondable et documentée |
| Ticket créé depuis email | Oui | fil email conservé ou exportable |
| Formulaire initial | Oui | copie intégrale générée |
| Portail obligatoire | Parfois | export complet + accusé opposable |
| `no-reply` | Rarement | canal de réponse contextuel équivalent |
| Messagerie captive sans export | Non, sauf cas très sensibles | export probatoire disponible |
| Chatbot obligatoire sans humain | Non | escalade humaine traçable |
| Notification sans contenu | Partiellement | accès durable + export du message |
| Suppression d’historique à fermeture de compte | Non | archive préalable fournie |
...
| Critère | 0 | 1 | 2 |
|---|---|---|---|
| Copie intégrale | Aucune | Partielle | Complète |
| Horodatage | Absent | Visible mais faible | Complet et fiable |
| Identifiant stable | Absent | Instable ou interne | Stable et cité |
| Export | Impossible | Manuel / captures | Format standard |
| Mise en copie | Impossible | Indirecte | Native ou équivalente |
| Pièces jointes | Non listées | Listées | Listées + empreintes |
| Statuts | Opaques | Visibles | Historisés |
| Décision | Non motivée | Partiellement | Motivée + recours |
| Journal | Inaccessible | Partiel | Exportable |
| Correction | Invisible | Possible | Visible et historisée |

Score maximal : 20.

Lecture provisoire :

- **16–20** : traçabilité symétrique forte ;
- **11–15** : traçabilité acceptable mais perfectible ;
...
- `.eml` pour les messages ;
- `.mbox` pour les fils ;
- `.pdf/A` pour les archives lisibles ;
- `.json` ou `.yaml` pour les données structurées ;
...
> Suite à notre échange du [date], je comprends que [fait]. Merci de me signaler toute erreur dans cette compréhension.
...
Exact. Mais la conclusion ne doit pas être : donc portail opaque. La conclusion doit être : canal sécurisé et trace exportable.

### Objection 2 — Les usagers envoient n’importe quoi par email

Souvent vrai. Mais un formulaire peut structurer la demande tout en générant une copie complète. La structuration n’impose pas la captivité.

### Objection 3 — La mise en copie peut violer la confidentialité

Oui. Certains domaines exigent des restrictions. Mais l’interdiction générale de la copie externe n’est pas justifiée. Il faut distinguer les cas : avocat, mandat, tutelle, association agréée, représentant légal, tiers explicitement autorisé.

### Objection 4 — Les organismes ont besoin d’outils métier

Oui. La critique ne porte pas sur les outils métier internes. Elle porte sur le fait que ces outils deviennent la seule mémoire exploitable de l’échange.

### Objection 5 — L’export complet coûte cher

Peut-être. Mais l’absence d’export coûte aussi : contentieux, perte de confiance, erreurs non détectées, charge de médiation, répétition des demandes, soupçon d’arbitraire, incapacité d’audit.

### Objection 6 — La transparence peut exposer les agents

Il ne faut pas confondre traçabilité et exposition sauvage. Une bonne architecture peut protéger les agents contre le harcèlement tout en garantissant l’imputabilité institutionnelle des actes.

### Objection 7 — Tout cela risque d’alourdir les procédures
...
> Dans toute interaction significative entre un individu et une personne morale, la traçabilité symétrique devrait être la règle ; la captivité de la trace devrait être l’exception, justifiée, proportionnée, compensée et contestable.

Cette règle peut être résumée en cinq exigences :

1. **Copier** : l’individu doit recevoir une copie complète de ses actes.
2. **Exporter** : il doit pouvoir sortir ses traces du système.
3. **Transmettre** : il doit pouvoir les communiquer à un tiers légitime.
4. **Contester** : il doit pouvoir relier une trace à une demande, une décision ou un silence.
5. **Auditer** : les cas individuels doivent pouvoir nourrir une lecture systémique.

Formule de synthèse :

> Une relation traçable n’est pas seulement une relation mieux archivée. C’est une relation où le pouvoir de dire ce qui s’est passé n’est pas monopolisé par la partie la plus forte.
...
3. Le texte donne-t-il assez de poids aux exigences de sécurité et de confidentialité ?
4. Le score proposé est-il utile ou trop mécaniste ?
5. Quels cas empiriques doivent être ajoutés en priorité : ANEF, CAF, MSA, CPAM, banques, assurances, opérateurs télécoms, plateformes sociales, universités, hôpitaux ?
6. Faut-il séparer plus fortement les acteurs publics soumis au droit administratif et les acteurs privés soumis au droit de la consommation, au droit des contrats et au droit des données personnelles ?
7. Quels standards recommander précisément : `.eml`, `.mbox`, `.pdf/A`, `.json`, `.yaml`, ASiC-E, eIDAS, horodatage qualifié ?
8. Comment éviter que la mise en copie ne devienne un outil d’intimidation ?
9. Comment articuler ce texte avec l’identité numérique européenne, les portefeuilles d’identité et les coffres-forts numériques ?
10. Faut-il proposer une clause législative type ?
11. Comment mesurer empiriquement la perte de capacité probatoire ?
12. Comment éviter une inflation documentaire contre-productive ?
13. Comment protéger les agents tout en rendant les actes imputables ?
14. Le texte doit-il devenir un article académique, un manifeste, une grille d’audit, ou les trois sous forme de produits déclinés ?
...
- services fiscaux ;
- plateformes de collectivités ;
- services clients privés fortement régulés ;
- opérateurs télécoms ;
...
Le courriel Internet standard n’est pas la solution finale. Il est le témoin historique d’un Internet plus interopérable, plus copiable, plus distribuable, donc plus favorable à une certaine symétrie minimale entre parties.

L’enjeu n’est donc pas de défendre l’email contre les portails. L’enjeu est de refuser que la modernisation numérique devienne une dépossession probatoire silencieuse.
...
- RFC 5321, *Simple Mail Transfer Protocol*, RFC Editor / IETF, 2008.
- RFC 5322, *Internet Message Format*, RFC Editor / IETF, 2008.
- RFC 6376, *DomainKeys Identified Mail (DKIM) Signatures*, RFC Editor / IETF, 2011.
- RFC 7208, *Sender Policy Framework (SPF)*, RFC Editor / IETF, 2014.
- RFC 7489, *Domain-based Message Authentication, Reporting, and Conformance (DMARC)*, RFC Editor / IETF, 2015.
- Référentiel général d’interopérabilité, France.
- Défenseur des droits, travaux sur la dématérialisation des services publics, l’accès aux droits et les algorithmes publics.
