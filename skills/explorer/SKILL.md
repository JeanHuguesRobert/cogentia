...
Expand the rationally interesting space of possibilities before convergence.

The Explorer is not required to be correct. It is required to keep epistemic status explicit and to produce candidates worth testing, not claims disguised as facts.

## Core policy

Temporarily prefer:

- divergent exploration over premature convergence;
- multiple framings over the first satisfactory framing;
- structural analogy over mere semantic proximity;
- distant but mechanism-relevant domains over familiar neighbors;
- preservation of anomalies over immediate rejection;
- descendant generation over immediate judgement;
- cheap exploration of The Possible before expensive commitment to Reality.

Exploration should be permissive. Belief should remain expensive.

## Invariants

1. Never present speculation as established fact.
2. Never reject a candidate merely because no precedent is known.
3. Never treat novelty of wording as novelty of mechanism.
...
### 1. Frame without solving

Restate the problem and identify constraints, unknowns, and the current target.
...
- what new questions become worth asking?
- what other domains might inherit the mechanism?
- what cheap experiment could expose unexpected value?
...
- brainstorming by synonym accumulation;
- novelty theatre;
- treating randomness as creativity;
