...
7. **Produce Projection Coverage Report.** Highlight undisposed relevant items, partial integration, epistemic/structural propagation failures, stale deferrals, contradictions, post-candidate source changes and suspicious cross-locality copying. Coverage is an aid, not proof of completeness.
...
**Suicide Corse n°2**: from frozen 17 September 2026 edition to current Corpus; target candidate n°2; resolve MSL rather than sweeping the whole Corpus. Success includes finding content, epistemic or structural propagation failures, or traceably finding none. Record false positives and reviewer effort.
